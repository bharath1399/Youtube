...
import logo_light_theme from "../assests/yt.png";
import logo_dark_theme from "../assests/yt.png";
    ...
    <div className={!isSideBarOpen && "hidden"}>
      ...
      <div className="sidebar2 border dark:border-none flex  flex-col w-[15rem]  h-full overflow-y-scroll overflow-x-hidden absolute top-0 left-0 bg-white z-20 dark:bg-zinc-900 dark:text-white">
        ...
        <div className="first-part flex pl-2 pr-6  pb-4 flex-col text-sm w-[15rem] ">
          ...
          <div className="Youtube-Premium py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <FaYoutube size="1.4rem" className="mb-1 mr-4" />
            <span>Youtube Premium</span>
          </div>
          <div className="Youtube-music py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <SiYoutubemusic size="1.4rem" className="mb-1 mr-4" />
            <span>Youtube Music</span>
          </div>
          <div className="Youtube-kids py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <TbMoodKid size="1.4rem" className="mb-1 mr-4" />
            <span>Youtube kids</span>
          </div>
          <div className="Youtube-TV py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
          ...
          <div className="links1 py-2 px-4  flex gap-1 flex-wrap font-medium text-[0.84rem] text-[#606060]">
            ...
            <div className="cursor-pointer ml-1">How Youtube works</div>
